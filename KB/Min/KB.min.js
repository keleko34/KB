...
d=f(e,d,a),e=b(e,a),h=[],c="appendChild"!==a.attr?c.querySelectorAll("*"):a.arguments[0].querySelectorAll("*"),g=c.length,v,k=0;for(v=0;v<g;v++)3!==c[v].nodeType&&8!==c[v].nodeType&&(h[k]=c[v],k++);"appendChild"===a.attr&&(c=a.arguments[0].nodeType,3!==c&&8!==c&&(h[h.length]=a.arguments[0]));for(c=0;c<d.length;c++)d[c].kb_addInputBinding();for(c=0;c<e.length;c++)e[c].kb_addInputBoxBinding();0<l["*"].length||0<r["*"].length?x("*",h):(A(h),B(h))}else a.stopPropagation()}function f(a,b,c){var f=a.length,
d=b.length,e=[],h,g=0;for(h=0;h<f;h++){var k=a[h].type;"radio"!==k&&"checkbox"!==k&&void 0===a[h].kb_onkeydown&&void 0===a[h].kb_onmousedown&&(e[g]=a[h],g++)}for(h=0;h<d;h++)e[g]=b[h],g++;"appendChild"===c.attr&&(a=c.arguments[0],b=a.tagName,"INPUT"===b&&"checkbox"!==a.type&&"radio"!==a.type||"TEXTAREA"===b)&&(e[e.length]=a);return e}function b(a,b){var c=a.length,f=[],d,e=0;for(d=0;d<c;d++){var h=a[d].type;if("radio"===h||"checkbox"===h&&void 0===a[d].kb_onkeydown&&void 0===a[d].kb_onmousedown)f[e]=
a[d],e++}"appendChild"===b.attr&&(c=b.arguments[0],"INPUT"===c.tagName&&"checkbox"===c.type&&"radio"===c.type&&(f[f.length]=c));return f}function h(a){var b=a.target.attributes[a.arguments[0]],c="setAttribute"===a.attr?a.arguments[1]:"";p(a.target,a.arguments[0],c,void 0!==b?b.value:"",[c])||a.preventDefault()}function c(a){var b=a.target.attributes[a.arguments[0]],c="setAttribute"===a.attr?a.arguments[1]:"";q(a.target,a.arguments[0],c,void 0!==b?b.value:"",[c])}var d=Object.keys(k);for(g=0;g<d.length;g++)void 0===
k[d[g]].set&&e.injectPrototypes(k[d[g]].obj,p,q);e.addAttrUpdateListener("appendChild",a);e.addAttrUpdateListener("removeChild",a);e.addAttrUpdateListener("innerHTML",a);e.addAttrUpdateListener("outerHTML",a);e.addAttrUpdateListener("innerText",a);e.addAttrUpdateListener("outerText",a);e.addAttrUpdateListener("textContent",a);e.addAttrListener("setAttribute",h);e.addAttrListener("removeAttribute",h);e.addAttrUpdateListener("setAttribute",c);e.addAttrUpdateListener("removeAttribute",c);(function(){for(var a=
0,a=document.getElementsByTagName("INPUT"),c=document.getElementsByTagName("TEXTAREA"),d={attr:"initial"},c=f(a,c,d),d=b(a,d),a=0;a<c.length;a++)c[a].kb_addInputBinding();for(a=0;a<d.length;a++)d[a].kb_addInputBoxBinding()})()}function u(a,f){e.addAttrListener.call(this,a,f,!0)}function C(a,f){e.addAttrUpdateListener.call(this,a,f,!0)}var l={},r={},k={},t=Object.getOwnPropertyNames(document.body.style),g,w,x=function(a,f){void 0===f&&(f=Array.prototype.slice.call(document.body.querySelectorAll("*")),
f.unshift(document.body));var b,h=f.length;if("*"===a){var c=t.length,d;for(b=0;b<h;b++)for(d=0;d<c;d++)e.injectStyle(f[b],t[d],p,q)}else for(b=0;b<h;b++)e.injectStyle(f[b],a,p,q)},y=function(a,f,b,e){b=b?"kb_childAttrUpdateListeners":"kb_childAttrListeners";var c,d;e.child=a;a:for(;null!==a&&void 0!==a;)if(a=a.parentElement,null!==a&&void 0!==a&&(c=a[b]()[f],void 0!==c))for(d=c.length,w=0;w<d;w++)if(e.target=a,c[w].call(a,e),void 0!==e._stopPropogation)break a},z=function(a,f,b,e,c,d,m){this.stopPropagation=
function(){this._stopPropogation=!0};this.preventDefault=function(){this._preventDefault=!0};this.value=b;this.oldValue=e;this.target=a;this.attr=f;this.arguments=c;this.action=d;this.child=void 0;this.type=m},p=function(a,f,b,e,c){b=new z(a,f,b,e,c,"set");var d=l["*"],m;c=l[f];e=void 0!==a.kb_attrListeners?a.kb_attrListeners()[f]:void 0;if(void 0!==d)a:for(m=d.length,g=0;g<m;g+=1)if(d[g].call(a,b),void 0!==b._stopPropogation)break a;if(void 0!==c&&void 0===b._stopPropogation)a:for(d=c.length,g=0;g<
d;g+=1)if(c[g].call(a,b),void 0!==b._stopPropogation)break a;if(void 0!==e&&void 0===b._stopPropogation)a:for(c=e.length,g=0;g<c;g+=1)if(e[g].call(a,b),void 0!==b._stopPropogation)break a;y(a,f,!1,b);return void 0!==b._preventDefault?!1:!0},q=function(a,f,b,e,c,d){b=new z(a,f,b,e,c,d,"update");var m=r["*"],g;d=r[f];e=void 0!==a.kb_attrUpdateListeners?a.kb_attrUpdateListeners()[f]:void 0;if(void 0!==m)a:for(g=m.length,c=0;c<g;c+=1)if(m[c].call(a,b),void 0!==b._stopPropogation)break a;if(void 0!==d&&
void 0===b._stopPropogation)a:for(m=d.length,c=0;c<m;c+=1)if(d[c].call(a,b),void 0!==b._stopPropogation)break a;if(void 0!==e&&void 0===b._stopPropogation)a:for(d=e.length,c=0;c<d;c+=1)if(e[c].call(a,b),void 0!==b._stopPropogation)break a;y(a,f,!0,b);return void 0!==b._preventDefault?!1:!0},A=function(a){var f=Object.keys(l).filter(function(a){return-1!==t.indexOf(a)}).concat(Object.keys(r).filter(function(a){return-1!==t.indexOf(a)})),b,h=a.length,c,d=f.length;for(c=0;c<d;c++)for(b=0;b<h;b++)e.injectStyle(a[b],
f[c],p,q)},B=function(a){var f=function(a){var b=[];for(;null!==a&&void 0!==a;)a=a.parentElement,null!==a&&void 0!==a&&b.concat(Object.keys(a.kb_childAttrListeners()).filter(function(a){return-1!==t.indexOf(a)})).concat(Object.keys(a.kb_childAttrUpdateListeners()).filter(function(a){return-1!==t.indexOf(a)}));return b}(a[0]),b,h=a.length,c,d=f.length;for(c=0;c<d;c++)for(b=0;b<h;b++)e.injectStyle(a[b],f[c],p,q)};e.injectPrototypeProperty=function(a,f,b,h,c){var d=a.prototype,g=Object.getOwnPropertyDescriptor(d,
...
(this.kb_attrListeners()[a]=[]),this.kb_attrListeners()[a].push(f)),-1!==t.indexOf(a)&&x(a,b?this.querySelector("*"):[this])),this;"function"===typeof f&&(void 0===l[a]&&(l[a]=[]),l[a].push(f),"*"!==a&&-1===t.indexOf(a)||x(a));return e};e.addAttrUpdateListener=function(a,f,b){if(this.toString()!==e.toString())return"function"===typeof f&&(b?(b&&void 0===this.kb_childAttrUpdateListeners()[a]&&(this.kb_childAttrUpdateListeners()[a]=[]),this.kb_childAttrUpdateListeners()[a].push(f)):(void 0===this.kb_attrUpdateListeners()[a]&&
(this.kb_attrUpdateListeners()[a]=[]),this.kb_attrUpdateListeners()[a].push(f))),this;"function"===typeof f&&(void 0===r[a]&&(r[a]=[]),r[a].push(f));return e};e.getAttrListeners=function(){return this.toString()!==e.toString()?this.kb_attrListeners():l};e.getAttrUpdateListeners=function(){return this.toString()!==e.toString()?this.kb_attrUpdateListeners():r};e.removeAttrListener=function(a,f){if(this.toString()!==e.toString()){if(void 0!==this.kb_attrListeners&&void 0!==this.kb_attrListeners()[a]&&
"function"===typeof f){for(var b=0;b<this.kb_attrListeners()[a].length;b+=1)this.kb_attrListeners()[a][b].toString()===f.toString()&&this.kb_attrListeners()[a].splice(b,1);if(void 0!==this.kb_childAttrListeners()[a])for(b=0;b<this.kb_childAttrListeners()[a].length;b+=1)this.kb_childAttrListeners()[a][b].toString()===f.toString()&&this.kb_childAttrListeners()[a].splice(b,1)}return this}if(void 0!==l[a]&&"function"===typeof f)for(b=0;b<l[a].length;b+=1)l[a][b].toString()===f.toString()&&l[a].splice(b,
1);return e};e.removeAttrUpdateListener=function(a,f){if(this.toString()!==e.toString()){if(void 0!==this.kb_attrUpdateListeners&&void 0!==this.kb_attrUpdateListeners()[a]&&"function"===typeof f){for(var b=0;b<this.kb_attrUpdateListeners()[a].length;b+=1)this.kb_attrUpdateListeners()[a][b].toString()===f.toString()&&this.kb_attrUpdateListeners()[a].splice(b,1);if(void 0!==this.kb_childAttrUpdateListeners()[a])for(b=0;b<this.kb_childAttrUpdateListeners()[a].length;b+=1)this.kb_childAttrUpdateListeners()[a][b].toString()===
f.toString()&&this.kb_childAttrUpdateListeners()[a].splice(b,1)}return this}if(void 0!==r[a]&&"function"===typeof f)for(b=0;b<r[a].length;b+=1)r[a][b].toString()===f.toString()&&r[a].splice(b,1);return e};e.injectPrototypes(Node,p,q);e.injectPrototypes(Element,p,q);e.injectPrototypes(HTMLElement,p,q);e.injectPrototypes(HTMLInputElement,p,q);e.injectPrototypes(HTMLTextAreaElement,p,q);e.injectPrototypes(Document,p,q);return e}"function"===typeof define&&define.amd?(define("KB",u),define([],function(){return u})):
"object"===typeof module&&module.exports&&(module.exports=u);return u}();
